...
# install packages
yay -S \
    audacity adw-gtk-theme awesome-luajit-git bc bluetui discord firefox fish freecad fd fuse2 github-cli ghostscript gimp git-lfs gnome-keyring google-chrome \
    ...
    pcmanfm perl-image-exiftool picom-git pre-commit prusa-slicer qdirstat qemu-desktop ranger ripgrep rclone rsync rofi rpcs3-bin ruby steam \
